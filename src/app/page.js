...
const HomePage = () => {
  return (
    <div className=" bg-cover bg-center min-h-[120vh] -mt-32 mb-96 -z-50" style={{ backgroundImage: "url('/assets/bg.png')" }}>
      ...
      <div className="absolute inset-0 flex justify-center items-center z-0 lg:mt-[92vh] mt-[50vh] "> {/* Ensure absolute positioning and pointer events are disabled */}
