      ...
      <Container className=" mt-96 ">
        ...
        <div className="flex lg:flex-row flex-col gap-4 my-4 p-4">
          ...
          <div className=" lg:w-2/3 w-full ">
            <Image data-aos="fade-left" data-aos-duration="1000" className="w-full h-full" src={imgLg} alt="img" />
          </div>
        </div>
        ...
        <div className="flex lg:flex-row flex-col gap-4 my-4 p-4">
          ...
          <div className="lg:w-2/3 w-full flex gap-4">
            <div className=" w-[50vw]  rounded-lg">
              <Image data-aos="fade-right" data-aos-duration="1000"  className="rounded-3xl h-full" src={imgSm} alt="img" />
            </div>
