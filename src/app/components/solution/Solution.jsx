    ...
    <div className="flex justify-center items-center my-20 mx-4">
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-4 grid-cols-1">
          <div className="border-2 border-zinc-500 rounded-3xl card-gradient2">
            <Image className="rounded-t-3xl" src={solnImg1} alt="img" />
           <div className="p-4">
           <h1 className="text-3xl font-bold">Fytobyte Limited</h1>
            <h1 className="text-md font-bold">Solutions</h1>
            <p>
          ...
          <div className="border-2 border-zinc-500 rounded-3xl card-gradient3">
            <Image className="rounded-t-3xl" src={solnImg1} alt="img" />
           <div className="p-4">
           <h1 className="text-3xl font-bold">Fytobyte Limited</h1>
            <h1 className="text-md font-bold">Solutions</h1>
          ...
          <div className="border-2 border-zinc-500 rounded-3xl card-gradient1">
            <Image className="rounded-t-3xl" src={solnImg1} alt="img" />
           <div className="p-4">
           <h1 className="text-3xl font-bold">Fytobyte Limited</h1>
            <h1 className="text-md font-bold">Solutions</h1>
